    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/img/getCode?time=" + new Date());
            });
        });
    </script>
</head>
<body>
<div class="login">
    <form id="loginForm" action="${pageContext.request.contextPath}/admin/getOne" method="post">
        <table>
            <tbody>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/img/getCode"
                         title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
