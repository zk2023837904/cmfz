...
<head>
    ...
    <script type="text/javascript">
                ...
                success: function (data) {
                    $.each(data, function (index, first) {
                        ...
                        $.each(first.list, function (index1, second) {
                            a += "<p style='text-align:left'><a id=\"btn\" href=\"#\" class=\"easyui-linkbutton\" onclick=\"addMenuTabs('" + second.title + "','" + second.iconCls + "','" + second.url + "')\" data-options=\"iconCls:'" + second.iconCls + "',plain:true\">" + second.title + "</a></p>";
                        })
                        $("#aa").accordion('add', {
                            title: first.title,
                            iconCls: "icon-tip",
        ...
        function addMenuTabs(title, iconCls, url) {
